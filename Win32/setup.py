...
if RUN_PY2EXE:
    ...
    shutil.copytree('dist', '0.004012006')
    TARBALL = tarfile.open('0.004012006.tar.gz', 'w:gz')
    TARBALL.add('0.004012006')
    TARBALL.close()

    # Create SHA256 sum
    CKSUM = cksum_path('0.004012006.tar.gz', 'sha256')
    CKSUMFILE = open('0.004012006.tar.gz.sha256', 'wb')
