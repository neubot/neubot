...
<div>
    <p>The `raw` test is a test that characterizes your Internet connection
       ...
       the download goodput.  The test does not emulate any protocol, and
       just sends random data, but takes download goodput snapshots during
       the test, as well as process load information and TCP statistics.
       The plan is to use this test's results to study certain TCP properties
       that may lead to a better understanding of network neutrality.  For
       sure, we aim to backport innovations introduced by this test to the other
       transmission tests.</p>
