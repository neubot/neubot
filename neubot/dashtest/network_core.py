# neubot/dashtest/network_core.py
...
class StreamSocket(object):
    ...
    def sock_bind(self, family, address, port):
        """ Bind at the specified family, address, and port """
        self.sock_socket = socket.socket(family, socket.SOCK_STREAM, 0)
    ...
    def sock_connect(self, family, address, port):
        """ Connect to the specified family, address, and port """
        #
    ...
    def sock_recv(self, count):
        ...
        self.sock_poller.set_readable(self)

    def _tcp_recv(self):
        """ Perform the recv() operation """
        self.sock_poller.unset_readable(self)
        try:
    ...
    def sock_send(self, data):
        ...
        self.sock_poller.set_writable(self)

    def _tcp_send(self):
        """ Perform the send() operation """
        self.sock_poller.unset_writable(self)
        try:
    ...
    def sock_close(self):
        """ Close this socket """
        self.sock_poller.close(self)

    def handle_close(self):
        """ Invoked when the connection is closed """
        logging.debug("network: handle_close(): %s", self)
        try:
    ...
    def handle_periodic(self, ticks):
